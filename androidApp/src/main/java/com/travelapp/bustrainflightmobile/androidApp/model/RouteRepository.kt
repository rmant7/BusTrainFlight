package com.travelapp.bustrainflightmobile.androidApp.model

import com.travelapp.bustrainflightmobile.androidApp.infrastructure.persistence.RoutesDbJson
import com.travelapp.bustrainflightmobile.androidApp.model.data.*
...
//    }
    ...
    fun getPackOfRoutesFromLocation(
        ...
        Napier.d(fullSortedRoutesFromCurrentLocation.toString())
