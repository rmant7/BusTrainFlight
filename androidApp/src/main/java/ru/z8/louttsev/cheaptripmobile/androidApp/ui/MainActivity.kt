...
import ru.z8.louttsev.cheaptripmobile.androidApp.adapters.AnywhereListAdapter
...
import ru.z8.louttsev.cheaptripmobile.androidApp.viewmodel.AutoCompleteHandler
...
//    }
    ...
    private fun AutoCompleteTextView.setup(
        ...
        doAfterTextChanged { changedEditableText: Editable? ->
            Log.d("asdfg", "doAfterTextChanged")
        ...
        setOnItemClickListener { parent: AdapterView<*>, _, position: Int, _ ->
            ...
            Log.d("asdfg", "setOnItemClickListener")
...
//                binding.resultsTextView.visibility = View.VISIBLE
        ...
        setOnDismissListener {
            Napier.d("OnDismiss")
            Log.d("asdfg", "setOnDismissListener")
